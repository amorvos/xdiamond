...
public class LogbackEnvListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        String contextSpringProfileActive = sce.getServletContext().getInitParameter("spring.profiles.active");
        ...
        if (System.getProperty("logback.env") == null) {
            String contextSpringProfileDefault = sce.getServletContext().getInitParameter("spring.profiles.default");
